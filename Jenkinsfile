pipeline {
    ...
    environment {
        IMAGE_NAME = "course-tracker"
        PROD_CONTAINER = "course-tracker-prod"
        STAGING_CONTAINER = "course-tracker-staging"

        // DO NOT use 806 (Jenkins is using it)
        PROD_PORT = "9000"
        STAGING_PORT = "9001"
    }
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                git branch: 'main',
                url: 'https://github.com/Suhar121/course_tracker.git'
            }
        }
